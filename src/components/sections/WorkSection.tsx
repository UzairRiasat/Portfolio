...
const WorkSection = () => {
  ...
  return (
    <section id="work" className="py-20 xl:py-32">
          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => (
              <div key={index} className="relative sm:pl-14 xl:pl-16">
                <div className="absolute left-0 top-8 hidden sm:flex w-10 h-10 xl:w-12 xl:h-12 items-center justify-center">
                  <div className="w-3 h-3 rounded-full bg-accent shadow-glow-sm ring-4 ring-accent/20" />
                </div>

                <div className="glass-card-hover p-6 xl:p-8">
